...
//   import { ReactNode } from 'react';
  ...
  import Logo1 from "./Crackdeal.png";
  import "./footer.css"
  const Logo = (props) => {
    return (
      <svg
        ...
        <Container as={Stack} maxW={'6xl'} py={10}>
          <SimpleGrid
            ...
            <ListHeader>POLICY INFO</ListHeader>
              <Link className='font' href={'https://www.snapdeal.com/page/privacy-policy'}>Privacy Policy</Link>
              <Link className='font' href={'https://www.snapdeal.com/page/terms-of-sale'}>Terms of Sale</Link>
              <Link className='font' href={'https://www.snapdeal.com/offers/terms-of-use'}>Terms of Use</Link>
              <Link className='font' href={'https://www.snapdeal.com/page/abusePolicy'}>Report Abuse </Link>
              <Link className='font' href={'https://www.snapdeal.com/helpcenter'}>FAQ</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>COMPANY</ListHeader>
              <Link className='font' href={'https://impactatsnapdeal.com/'}>Impact @ Crackdeal</Link>
              <Link className='font' href={'https://jaspercareers.peoplestrong.com/home'}>Careers</Link>
              <Link className='font' href={'https://blog.snapdeal.com/'}>Blogs</Link>
              <Link className='font' href={'https://www.snapdeal.com/page/sitemap'}>Site Map</Link>
              <Link className='font' href={'https://www.snapdeal.com/helpcenter/customercare'}>Contact Us</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>CRACKDEAL BUSSINESS</ListHeader>
              <Link className='font' href={'https://play.google.com/store/apps/details?id=com.snapdeal.main&hl=en_IN'}>Shopping App</Link>
              <Link className='font' href={'https://sellers.snapdeal.com/'}>Sell on Crackdeal</Link>
              <Link className='font' href={'#'}>Media Enquiries</Link>
              
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader >POPULAR LINKS</ListHeader>
              <Link className='font' href={'https://www.snapdeal.com/products/women-apparel-lehenga?sort=plrty'}>Lehenga</Link>
              <Link className='font' href={'https://www.snapdeal.com/products/kids-clothing?sort=plrty'}>Kid's Clothing</Link>
              <Link className='font' href={'#'}>Sarees</Link>
              <Link className='font' href={'#'}>Winter wear</Link>
            ...
            <Stack align={'flex-start'}>
              ...
              Register now to get updates on promotions and coupons. 
               <a style={{color:"blue"}} href="https://play.google.com/store/apps/details?id=com.snapdeal.main"> Or Download App</a> 
              </Text>
